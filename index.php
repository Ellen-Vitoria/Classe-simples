...
echo "<p>O Frete do {$produto->nome} é: R$ {$produto->calcularFrete()}<p>"; // É recomendado colocar essa linha no Método, assim feito como na Classe anterior
...
$produto->setQt(2);
$produto->setTaxa(0.5);
$produto->frete = $produto->calcularFrete();
